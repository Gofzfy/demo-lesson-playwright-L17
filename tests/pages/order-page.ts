...
export class OrderPage extends BasePage {
  ...
  readonly confirmationPopupOKButton: Locator
  ...
  constructor(page: Page) {
    ...
    this.confirmationPopupOKButton = page.getByTestId('orderSuccessfullyCreated-popup-ok-button')
  ...
  async createOrder(): Promise<void> {
    ...
    await this.commentInput.fill(faker.word.words(4))
